...
#define MODULE_NAME "2024E8021682118_task3"

#define MEM_BASE 0x10000000 // 物理地址示例
...
{
    // 申请内存区域
    if (!request_mem_region(MEM_BASE, MEM_SIZE, "2024E8021682118_mmio"))
    {
    ...
    unsigned int data = ioread32(io_mem);
